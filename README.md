...
[gqlgen](https://github.com/bewolv/gqlgen) is a Go library for building GraphQL servers without any fuss. gqlgen is:
...
If you can't find what your looking for, look at our [examples](https://github.com/bewolv/gqlgen/tree/master/example) for example usage of gqlgen.

## Reporting Issues

If you think you've found a bug, or something isn't behaving the way you think it should, please raise an [issue](https://github.com/bewolv/gqlgen/issues) on GitHub.

## Contributing

Read our [Contribution Guidelines](https://github.com/bewolv/gqlgen/blob/master/CONTRIBUTING.md) for information on how you can help out gqlgen.
...
models:
  ID: # The GraphQL type ID is backed by
    model:
      - github.com/bewolv/gqlgen/graphql.IntID # An go integer
      - github.com/bewolv/gqlgen/graphql.ID # or a go string
```
